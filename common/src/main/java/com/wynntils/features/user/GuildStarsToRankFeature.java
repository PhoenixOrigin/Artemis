...
public class GuildStarsToRankFeature extends UserFeature {
    ...
    private static final Pattern guildMessage = Pattern.compile("§3\\[§b(★*)§3(.+)§3\\]§b (.*)");
    ...
    public void onChat(ChatMessageReceivedEvent event) {
        ...
        for (String url : urls) {
            ...
            tc.append(urlText.setStyle(urlText.getStyle().withClickEvent(clickEvent).withHoverEvent(hoverEvent)));
